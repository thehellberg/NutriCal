...
var express_file_routing_1 = require("express-file-routing");
...
var routing = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _b = (_a = app).use;
                _c = ['/'];
                return [4 /*yield*/, (0, express_file_routing_1.router)()];
            case 1:
